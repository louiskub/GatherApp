...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const post2 = new Post("SAT, FEB 1 - 8.00 P.M.", "ACTIVITY NAME 2", "Mondstadt", 5, 30, ["Games", "Fun"], "https://cdna.artstation.com/p/assets/images/images/056/458/766/large/mathias-zamecki-genshin-approval.jpg?1669289221", 123);
    const post3 = new Post("SUN, FEB 2 - 10.00 A.M.", "ACTIVITY NAME 3", "Inazuma", 10, 100, ["Art", "Craft"], "https://assetsio.gnwcdn.com/How-to-get-to-Inazuma-in-Genshin-Impact-cover.jpg?width=1200&height=1200&fit=crop&quality=100&format=png&enable=upscale&auto=webp", 50);
    ...
    postInDateList.forEach(postInDate => searchPostContainer.appendChild(postInDate.render()));
